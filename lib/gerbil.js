var Gerbil = function Gerbil(description, tests) {
  ...
  this.fail = function(test) {
    this.failures++;
    var message = Gerbil.format("{0} - assertion failed - {1}", [
...
Gerbil.formatter = {
  ...
  summary: function(summary) {
    var summaryString = Gerbil.format("All tests completed for {0}: {1} passed, {2} failed, {3} pending, of {4} tests in {5} s", [
      summary.description,
      summary.pass,
      summary.fail,
      summary.pending,
